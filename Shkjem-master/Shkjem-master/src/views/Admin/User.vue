<template>
  <div>
    ...
    <el-table border :data="tableData" v-loading="loading" style="width: 100%">
      ...
      <el-table-column prop="orgnazation" label="所属单位"></el-table-column>
      <el-table-column prop="teach_Class" label="所教课程"></el-table-column>
      <el-table-column prop="active" label="活跃度"></el-table-column>
